...
extern struct dhcp_client_t *dhcp_client_alloc(struct ip_datalink_instance *idi, const char *client_name, dhcp_client_callback_t callback, void *callback_arg);
