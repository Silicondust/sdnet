...
extern bool ip_addr_is_ipv4_autoip(const ip_addr_t *ip);
extern bool ip_addr_is_ipv4_broadcast(const ip_addr_t *ip);
extern bool ip_addr_is_ipv4_routable(const ip_addr_t *ip);
extern bool ip_addr_is_ipv6_localhost(const ip_addr_t *ip);
extern bool ip_addr_is_ipv6_link_local(const ip_addr_t *ip);
extern bool ip_addr_is_ipv6_public(const ip_addr_t *ip);
extern bool ip_addr_is_ipv6_multicast(const ip_addr_t *ip);
...
extern inline bool ip_addr_is_ipv6_link_local(const ip_addr_t *ip)
{
	return false;
}
...
extern inline bool ip_addr_is_ipv6_multicast(const ip_addr_t *ip)
{
	return false;
}
