...
extern uint8_t ip_interface_get_ip_score(struct ip_interface_t *idi);
...
extern bool ip_interface_is_ipv6_linklocal(struct ip_interface_t *idi);
...
extern struct ip_interface_t *ip_interface_manager_get_by_ifindex_best_ipv4(uint32_t ifindex);
...
extern inline bool ip_interface_is_ipv6_linklocal(struct ip_interface_t *idi) { return false; }
