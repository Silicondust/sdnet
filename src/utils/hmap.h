...
/* Implementation. */
extern struct hmap_prefix_t *hmap_find_impl(struct hmap_t *map, uint64_t hash);
extern struct hmap_prefix_t *hmap_next_impl(struct hmap_t *map, uint64_t hash);
extern bool hmap_add_impl(struct hmap_t *map, struct hmap_prefix_t *item, uint64_t hash);
extern struct hmap_prefix_t *hmap_remove_impl(struct hmap_t *map, uint64_t hash);
extern struct hmap_prefix_t *hmap_remove_top_impl(struct hmap_t *map);
extern struct hmap_prefix_t *hmap_replace_impl(struct hmap_t *map, struct hmap_prefix_t *item, uint64_t hash);
