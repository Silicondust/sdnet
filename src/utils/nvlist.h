...
extern struct nvlist_entry_t *nvlist_lookup_altname(struct slist_t *list, const char *name1, const char *name2);
extern const char *nvlist_lookup_str(struct slist_t *list, const char *name, const char *value_on_error);
extern const char *nvlist_lookup_str_altname(struct slist_t *list, const char *name1, const char *name2, const char *value_on_error);
extern int64_t nvlist_lookup_int64(struct slist_t *list, const char *name, int64_t value_on_error);
extern int64_t nvlist_lookup_int64_altname(struct slist_t *list, const char *name1, const char *name2, int64_t value_on_error);
