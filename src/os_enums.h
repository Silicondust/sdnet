...
enum {
	...
	MEM_TYPE_OS_WEBCLIENT_OPERATION = 76,
	MEM_TYPE_OS_WEBCLIENT_HTTP_TAG_LIST = 77,
	MEM_TYPE_OS_APPFS_DATA = 78,
	MEM_TYPE_OS_TLS_SERVER_SOCKET = 79,
	MEM_TYPE_OS_TLS_SERVER_CONNECTION = 80,
	MEM_TYPE_OS_DES3_INSTANCE = 81,
	MEM_TYPE_OS_AES_INSTANCE = 82,
	MEM_TYPE_OS_UDP_MULTIPATH = 83,
	MEM_TYPE_OS_GUNZIP = 84,
	MEM_TYPE_OS_GUNZIP_ZALLOC = 85,
	MEM_TYPE_OS_NVLIST_ENTRY = 86,
	MEM_TYPE_OS_XML_PROCESS = 87,
	MEM_TYPE_OS_JSON_PROCESS = 88,
	MEM_TYPE_OS_WEBSERVER_CONNECTION_ADDITIONAL_RESPONSE_HEADER = 89,
	MEM_TYPE_OS_WEBSOCKET_SERVICE_CONNECTION = 90,
	MEM_TYPE_OS_DNS_TLS = 91,
	MEM_TYPE_OS_MDNS_RESPONDER_NAME = 92,
	MEM_TYPE_OS_IGMP_ENTRY = 93,
	MEM_TYPE_OS_FILE_WASYNC = 94,
	MEM_TYPE_OS_FILE_WASYNC_OPERATION = 95,
	MEM_TYPE_OS_FILE_SENDFILE = 96,
	MEM_TYPE_OS_TCP_SENDFILE = 97,
	MEM_TYPE_OS_DHCP_SERVER_CLIENT = 98,
	MEM_TYPE_OS_IP_MANAGED = 99,
	MEM_TYPE_OS_IP_INTERFACE_DETECT = 100,
	MEM_TYPE_OS_DNS_RESPONDER_NAME = 101,
	MEM_TYPE_OS_WEBSERVER_CONNECTION_HOST_NAME = 102,
	MEM_TYPE_OS_HTTP_PARSER_HEADER_NAME = 103,
	MEM_TYPE_OS_XML_ELEMENT = 104,
	MEM_TYPE_OS_XML_ATTRIBUTE = 105,
};
